...
import 'modal_edit_shipper_profile_model.dart';
export 'modal_edit_shipper_profile_model.dart';

class ModalEditShipperProfileWidget extends StatefulWidget {
  const ModalEditShipperProfileWidget({super.key});

  @override
  State<ModalEditShipperProfileWidget> createState() =>
      _ModalEditShipperProfileWidgetState();
}

class _ModalEditShipperProfileWidgetState
    extends State<ModalEditShipperProfileWidget> with TickerProviderStateMixin {
  late ModalEditShipperProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalEditShipperProfileModel());
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'ttawfajq' /* Below are your profile details */,
                      ),
