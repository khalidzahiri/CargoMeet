...
import 'schema/drivers_posts_record.dart';
import 'schema/client_posts_record.dart';
...
export 'schema/drivers_posts_record.dart';
export 'schema/client_posts_record.dart';
...
/// Functions to query DriversPostsRecords (as a Stream and as a Future).
Future<int> queryDriversPostsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DriversPostsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DriversPostsRecord>> queryDriversPostsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DriversPostsRecord.collection,
      DriversPostsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DriversPostsRecord>> queryDriversPostsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query ClientPostsRecords (as a Stream and as a Future).
Future<int> queryClientPostsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ClientPostsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ClientPostsRecord>> queryClientPostsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ClientPostsRecord.collection,
      ClientPostsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ClientPostsRecord>> queryClientPostsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
